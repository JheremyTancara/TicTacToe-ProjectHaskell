...
/* package tictactoe-2dhaskell-0.1.0.0 */
#ifndef VERSION_tictactoe_2dhaskell
#define VERSION_tictactoe_2dhaskell "0.1.0.0"
#endif /* VERSION_tictactoe_2dhaskell */
#ifndef MIN_VERSION_tictactoe_2dhaskell
#define MIN_VERSION_tictactoe_2dhaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tictactoe_2dhaskell */
...
#define CURRENT_COMPONENT_ID "tictactoe-2dhaskell-0.1.0.0-HcAvc4PsuUc14tMZyNsvCR-tictactoe-2dhaskell"
